...
#input characters do not fulfill every criterion by Okta Reza#
...
class TestLogin(unittest.TestCase):
    ...
    def test_a_success_login(self):
       ...
       # Klik switch button "Create Login Details"
        ...
        ActionChains(self.driver).send_keys("asusgaming").perform()
        time.sleep(6)
